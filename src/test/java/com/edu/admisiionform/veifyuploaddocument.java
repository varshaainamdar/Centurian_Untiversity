...
public class veifyuploaddocument {
	...
	//	driver.findElement(By.xpath("//a[contains(text(),'Sign Up')]")).click();
		...
		JavaUtiity ranDom = new JavaUtiity();
		int ran = ranDom.getRanDomNumber();
		driver.findElement(By.id("in_eml")).sendKeys(Emailid+ran+"@gmail.com");
		...
		String corres1 = excel.getExcelData("sheet1", 6, 2);
		driver.findElement(By.id("cadr")).sendKeys(corres1);

		driver.findElement(By.id("cast")).sendKeys("karnataka");
		String corres2 = excel.getExcelData("sheet1", 6, 3);
		driver.findElement(By.id("cadr")).sendKeys(corres2);

		driver.findElement(By.id("capin")).sendKeys("560023");
		String corres3 = excel.getExcelData("sheet1", 6, 4);
		
		driver.findElement(By.id("camob")).sendKeys("9876543123");
		driver.findElement(By.id("cadr")).sendKeys(corres3);

		//permanant address
		String permanant = excel.getExcelData("sheet1", 7, 1);
		driver.findElement(By.id("padr")).sendKeys(permanant);
		
		String permanant1 = excel.getExcelData("sheet1", 7, 2);
		driver.findElement(By.id("past")).sendKeys(permanant1);
		
		String permanant2 = excel.getExcelData("sheet1", 7, 3);
		driver.findElement(By.id("papin")).sendKeys(permanant2);
		
		String permanant3 = excel.getExcelData("sheet1", 7, 3);
		driver.findElement(By.id("pamob")).sendKeys(permanant3);
		...
		//percentsge
		String percent1= excel.getExcelData("sheet1", 19, 1);
		driver.findElement(By.id("pom1")).sendKeys(percent1);
		...
		//totalmarks1
		String totalmarks2 = excel.getExcelData("sheet1", 22, 1);
		driver.findElement(By.id("tm2")).sendKeys(totalmarks2);
		...
		//division
		String division2 = excel.getExcelData("sheet1", 24, 1);
		driver.findElement(By.id("divs2")).sendKeys(division2);

	
		//percentage1
		String percentage3= excel.getExcelData("sheet1", 25, 1);
		driver.findElement(By.id("pom2")).sendKeys(percentage3);
